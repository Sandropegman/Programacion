...
public class ProductoDAOImpl implements ProductoDAO {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/productos?useSSL=false";
    ...
    public void update(Producto producto) {
        ...
        try {
            ...
            throw new RuntimeException("Error al actualizar el producto: " + ex.getMessage());
        } finally {
            if (conn != null) {
                try {
                    conn.close();
    ...
    public void delete(Producto producto) {
        ...
        try {
            ...
            throw new RuntimeException("Error al eliminar el producto: " + ex.getMessage());
        } finally {
            if (conn != null) {
                try {
                    conn.close();
